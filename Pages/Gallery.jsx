...
<div className='mt-10 flex flex-col justify-center items-center gap-6 p-4 flex-wrap md:flex md:flex-row'>
    <div className='hover:scale-105 transition-all duration-300'  >
     ...
     <img src={assets.f6} alt='flower' className='w-64 h-64 rounded-4xl'></img>
    </div>
    <div className='hover:scale-105 transition-all duration-300' >
     ...
     <img src={assets.f5} alt='flower' className='w-64 h-64 rounded-4xl'></img>
    </div>
    <div className='hover:scale-105 transition-all duration-300' >
     ...
     <img src={assets.f4} alt='flower' className='w-64 h-64 rounded-4xl'></img>
    </div>
    <div className='hover:scale-105 transition-all duration-300' >
     ...
     <img src={assets.f2} alt='flower' className='w-64 h-64 rounded-4xl'></img>
    </div>
    <div className='hover:scale-105 transition-all duration-300' >
     <p className='text-[20px] font-semibold text-center mb-2'>RIVER STONE <span className='text-gray-600 text-[15px]'> ₹50/Bunch </span> </p>
     <img src={assets.ob8} alt='flower' className='w-64 h-64 rounded-4xl'></img>
    </div>
    <div className='hover:scale-105 transition-all duration-300' >
...
<div className=' mt-16  '>
    ...
    <img src={assets.f3} alt='flower' className='w-64 h-64 p-4 md:mr-10 rounded-[50px]  md:w-[500px] md:h-[400px] md:mt-4'></img>
    </div>
    ...
    <img src={assets.ob1} alt='flower' className='w-64 h-64 p-4 md:mr-10 rounded-[50px]  md:w-[500px] md:h-[400px] md:mt-4'></img>
</div>
<div className='w-1/2 h-px bg-black mt-6 mx-auto md:w-[1100px] md:mt-11'></div>
<div className='flex flex-col justify-between items-center md:flex-row'>
    ...
    <img src={assets.ob6} alt='flower' className='w-64 h-64 p-4 shadow-lg md:mr-10 rounded-[50px]  md:w-[500px] md:h-[400px] md:mt-4'></img>
</div>
